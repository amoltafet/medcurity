    ...
    { this.state.booleanonsubmit ? 
     ...
     <div className="Quiz_container_display"> 
       ...
       <div className="Quiz-MobileStepper">
        <MobileStepper  variant="text" steps={this.state.Quiz_Set.length} position="static" activeStep={this.state.activeStep}
            nextButton={
        ...
        <Row sm>
          <Col>
            <SaveAllButton value="Save All" questionData={data}></SaveAllButton>
          </Col>
          <Col>
